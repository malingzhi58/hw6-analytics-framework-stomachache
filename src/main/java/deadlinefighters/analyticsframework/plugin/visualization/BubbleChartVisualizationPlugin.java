...
/**
 * This is a bubble chart that supports 1 stock only
 */
    ...
    public String render(List<AggregatedStockQuotes> data) {
        ...
        try {
            ...
            sb.append("""
                ...
                var layout = {
                  dragmode: 'zoom',
                  title: 'Daily stock price difference (Open price - Close price) - ' + aggregated[0].symbol + (aggregated.length == 2 ? ` vs ${aggregated[1].symbol}` : ''),
                  xaxis: {
                    autorange: true,
                    title: 'Date',
                    type: 'date'
